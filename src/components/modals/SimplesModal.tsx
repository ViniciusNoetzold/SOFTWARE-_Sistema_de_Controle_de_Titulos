...
const mockTitulos: TituloPendente[] = [
  { id: '1', cliente: 'TechCorp Solutions', vencimento: '2026-08-15', valor: 5500.00 },
  { id: '2', cliente: 'Global Imports Ltda', vencimento: '2026-08-18', valor: 12000.00 },
  { id: '3', cliente: 'Comercial Silva', vencimento: '2026-08-20', valor: 350.50 },
  { id: '4', cliente: 'TechCorp Solutions', vencimento: '2026-08-25', valor: 8900.00 },
  { id: '5', cliente: 'Indústria ABC', vencimento: '2026-08-28', valor: 45000.00 },
];

export function SimplesModal({ isOpen, onClose }: { isOpen: boolean, onClose: () => void }) {
  ...
  const handleGerar = () => {
    ...
    alert(`Borderô Simples gerado com sucesso contendo ${selecionados.length} título(s)!`);
    setSelecionados([]);
    onClose();
  };
